...
class ArtViewModel: ObservableObject {
    ...
    let allFruits = ["art1", "art2", "art3","art4", "art5", "art6"]
    ...
    let symbolArray = [
        ...
        Symbol(image: "art2", value: "100"),
        Symbol(image: "art3", value: "75"),
        Symbol(image: "art4", value: "50"),
        Symbol(image: "art5", value: "25"),
        Symbol(image: "art6", value: "10")
    ]
