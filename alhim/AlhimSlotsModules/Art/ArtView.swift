...
struct ArtView: View {
    @StateObject var viewModel =  ArtViewModel()
        ...
        ZStack {
            ZStack(alignment: .bottom) {
                ZStack(alignment: .top) {
                    ...
                    ZStack(alignment: .bottom) {
                        LinearGradient(colors: [Color(red: 42/255, green: 225/255, blue: 238/255)], startPoint: .leading, endPoint: .trailing)
                            .frame(height: 70)
                        
                        Rectangle()
                            .foregroundStyle(Color(red: 42/255, green: 98/255, blue: 238/255))
                            .frame(height: 2)
                    }
                }
                    ...
                    VStack {
                        HStack(spacing: 10) {
                            Button(action: {
                                ...
                                Rectangle()
                                    .fill(Color(red: 17/255, green: 72/255, blue: 212/255))
                                    .overlay {
                            ...
                            .padding(.vertical, 5)
                            .background(LinearGradient(colors: [Color(red: 42/255, green: 225/255, blue: 238/255),
                                                                Color(red: 34/255, green: 184/255, blue: 195/255)], startPoint: .leading, endPoint: .trailing))
                            .cornerRadius(22)
                            .overlay {
                                RoundedRectangle(cornerRadius: 22)
                                    .stroke(Color(red: 42/255, green: 98/255, blue: 238/255), lineWidth: 1)
                            }
                        }
                        ...
                        VStack(spacing: 10) {
                            ZStack {
                                ...
                                Rectangle()
                                    .fill(Color(red: 22/255, green: 65/255, blue: 135/255))
                                    .overlay {
                                                    ...
                                                    ForEach(0..<3, id: \.self) { row in
                                                        HStack(spacing: 15) {
                                                            ForEach(0..<5, id: \.self) { col in
                                                                Rectangle()
                                                                    .fill(Color(red: 22/255, green: 111/255, blue: 187/255))
