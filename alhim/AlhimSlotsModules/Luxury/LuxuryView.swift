...
struct LuxuryView: View {
    @StateObject var viewModel =  LuxuryViewModel()
        ...
        ZStack {
            ZStack(alignment: .bottom) {
                ZStack(alignment: .top) {
                    ...
                    ZStack(alignment: .bottom) {
                        LinearGradient(colors: [Color(red: 34/255, green: 195/255, blue: 69/255)], startPoint: .leading, endPoint: .trailing)
                            .frame(height: 70)
                        
                        Rectangle()
                            .foregroundStyle(Color(red: 34/255, green: 195/255, blue: 69/255))
                            .frame(height: 2)
                    }
                }
                    ...
                    VStack {
                        HStack(spacing: 10) {
                            Button(action: {
                                ...
                                Rectangle()
                                    .fill(Color(red: 73/255, green: 180/255, blue: 18/255))
                                    .overlay {
                            ...
                            .padding(.vertical, 5)
                            .background(LinearGradient(colors: [Color(red: 52/255, green: 238/255, blue: 44/255),
                                                                Color(red: 34/255, green: 195/255, blue: 69/255)], startPoint: .leading, endPoint: .trailing))
                            .cornerRadius(22)
                            .overlay {
                                RoundedRectangle(cornerRadius: 22)
                                    .stroke(Color(red: 52/255, green: 238/255, blue: 44/255), lineWidth: 1)
                            }
                        }
                                            ...
                                            ForEach(0..<3, id: \.self) { row in
                                                HStack(spacing: 26) {
                                                    ForEach(0..<5, id: \.self) { col in
                                                        Rectangle()
                                                            .fill(Color(red: 81/255, green: 193/255, blue: 20/255).opacity(0.9))
                                                            .frame(width: 50, height: 50)
                                                            .overlay {
                                                                RoundedRectangle(cornerRadius: 8)
                                                                    .stroke(Color(red: 88/255, green: 238/255, blue: 43/255), lineWidth: 3)
                                                                    .overlay {
